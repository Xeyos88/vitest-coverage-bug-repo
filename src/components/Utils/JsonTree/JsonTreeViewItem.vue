  ...
  setup(props: Props, context: SetupContext) {
    ...
    function getValueColor(value: ValueTypes): string {
      return when(typeof value)
        .is((v: string) => v === 'string', then('var(--jtv-string-color)'))
        .is((v: string) => v === 'number', then('var(--jtv-number-color)'))
        .is((v: string) => v === 'bigint', then('var(--jtv-number-color)'))
        .is((v: string) => v === 'boolean', then('var(--jtv-boolean-color)'))
        .is((v: string) => v === 'object', then('var(--jtv-null-color)'))
        .is((v: string) => v === 'undefined', then('var(--jtv-null-color)'))
